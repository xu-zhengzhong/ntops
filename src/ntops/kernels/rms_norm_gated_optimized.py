...
def _arrange_last_dim(tensor, block_size):
    # The vLLM GDN path passes a 2-D (rows, head_dim) tensor. Keeping the
    # row dimension outside the hierarchy avoids the generic permutation and
    # flatten operations used by the baseline reduction arrangement.
